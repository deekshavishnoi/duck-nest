  ...
  return (
    <>
      ...
      <div className="sm:hidden">
        {/* Top bar */}
        <div className="fixed top-0 left-0 right-0 z-50 bg-[var(--card)]/90 backdrop-blur-xl border-b border-amber-100/60">
          ...
          {menuOpen && (
            <>
              ...
              <motion.nav
                ...
                className="fixed top-0 right-0 bottom-0 z-50 w-64 bg-[var(--bg)] border-l border-amber-100/60 shadow-xl pt-14 px-4 pb-6 overflow-y-auto"
              >
      ...
      <nav className="hidden sm:block fixed bottom-0 left-0 right-0 z-50 bg-[var(--card)]/90 backdrop-blur-xl border-t border-amber-100/60">
